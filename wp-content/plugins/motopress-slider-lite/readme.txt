...
Tags: slider, image slider, responsive slider, responsive slides, slideshow, content slider, video slider, vimeo slider, youtube slider, drag and drop slider, posts slider, woocommerce slider
...
Easy to use WordPress Slider plugin for creating responsive sliders, galleries and slideshows with stunning smooth effects and layers.
...
* [Slider Demo](https://mpsldemo.getmotopress.com/#motopress-try-demo)
* [WordPress Slider plugin](https://motopress.com/products/wordpress-slider/)
* [Documentation](https://motopress.com/documentation/wordpress/plugins/slider/)
* [Forums](https://motopress.com/forums/forum/wordpress/plugins/slider/)

= MotoPress Slider Pro =

Upgrade to [MotoPress Slider Pro](https://motopress.com/products/wordpress-slider/) to have access to the following features:
...
To discover more capabilities of the Posts slider type, please visit its [Documentation page](https://motopress.com/documentation/wordpress/plugins/slider/getting-started/how-to-add-a-posts-slider/).
...
To discover more capabilities of the WooCommerce slider type, please visit its [Documentation page](https://motopress.com/documentation/wordpress/plugins/slider/getting-started/how-to-add-a-woocommerce-slider/).

= Page builder integration = 

Slider can be added to Gutenberg, Elementor, Divi or any other builder via shortcode.

Proud developers of Responsive WordPress Slider plugin and the biggest set of blocks for Gutenberg - [Getwid WordPress Blocks](https://wordpress.org/plugins/getwid/).
...
Visit our [documentation page](https://motopress.com/documentation/wordpress/plugins/slider/) for more information on working with MotoPress Slider.

== Screenshots ==
1. Slides list
2. Slider settings
3. Slide settings and layers
4. Sliders list
